...
var assets = [
	"../../img/zhitouH5/lanscape.gif",
    "../../img/zhitouH5/bt_img.jpg",
	"../../img/zhitouH5/btn_xz.jpg",
	"../../img/zhitouH5/f_img.jpg",
	"../../img/zhitouH5/ld_l.png",
	"../../img/zhitouH5/ld_r.png",
	"../../img/zhitouH5/loading-move.jpg",
	"../../img/zhitouH5/scrollup.png",
	"../../img/zhitouH5/videoBlack.jpg",
	"../../img/zhitouH5/lanscape.gif",
	"../../img/zhitouH5/video_bg.jpg",
	"../../img/zhitouH5/jdb_img01.jpg",
	"../../img/zhitouH5/jdb_img02.jpg",
	"../../img/zhitouH5/jdb_img03.jpg",
	"../../img/zhitouH5/jdb_img04.jpg",
	"../../img/zhitouH5/img_1.png",
	"../../img/zhitouH5/img_2.png",
	"../../img/zhitouH5/img_3.png",
	"../../img/zhitouH5/img_4.png",
	"../../img/zhitouH5/img_5.png",
	"../../img/zhitouH5/videoImg_1.png",
	"../../img/zhitouH5/videoImg_2.png",
	"../../img/zhitouH5/page_1Txt_1.png",
	"../../img/zhitouH5/page_1Txt_2.png",
	"../../img/zhitouH5/page_1Txt_3.png",
	"../../img/zhitouH5/page_2Txt_1.png",
	"../../img/zhitouH5/page_2Txt_2.png",
	"../../img/zhitouH5/page_2Txt_3.png",
	"../../img/zhitouH5/page_3Txt_1.png",
	"../../img/zhitouH5/page_3Txt_2.png",
	"../../img/zhitouH5/page_3Txt_3.png",
	"../../img/zhitouH5/page_3Txt_4.png",
	"../../img/zhitouH5/logomax.png",
	"../../img/zhitouH5/video_txt1.png",
	"../../img/zhitouH5/video_txt2.png",
	"../../img/zhitouH5/back.gif"
...
var CanvasVideoPlayer = function(options) {
	...
	// Canvas context
	this.myctx = this.canvas.getContext('2d');
...
CanvasVideoPlayer.prototype.play = function() {
	...
	this.playing = true;
	this.loop();
   // console.log("this.options.audio",this.options.audio,this.audio);
	if (this.options.audio) {
...
CanvasVideoPlayer.prototype.drawFrame = function() {
    //console.log("prototype",this.width, this.height);
	this.myctx.drawImage(this.video, 0, 0, this.width, this.height);
};
...
var pageHome,pageHome_1,pageHome_2,pageHome_3,pageHome_4,pageHome_5,pageHome_6,pageHome_7,pageHome_8,pageHome_9;
var page_back,page_btn,page_downBtn;
var page_0,page_0_logo,page_0_txt1,page_0_video,page_0_videoimg_1,page_0_videoimg_2,page_0_videotxt_1,page_0_videotxt_2;
...
function playHome(){
    TweenMax.to(pageHome,2.5,{y:"-370",ease:Power4.easeOut,delay:1});
    TweenMax.to(pageHome_4,0,{autoAlpha:0});
    TweenMax.to(pageHome_5,0,{autoAlpha:0});
    TweenMax.to(pageHome_6,0,{autoAlpha:0});
    TweenMax.to(pageHome_4,.1,{autoAlpha:1,ease:Power4.easeOut,delay:1.8});
    TweenMax.to(pageHome_5,.2,{autoAlpha:1,ease:Power4.easeOut,delay:1.9});
    TweenMax.to(pageHome_6,.2,{autoAlpha:1,ease:Power4.easeOut,delay:2.3});
    TweenMax.to(pageHome,4,{y:"-1100",ease:Power4.easeOut,delay:5});
    if(isIphone){
        TweenMax.to(pageHome,4,{y:"-2211",ease:Power4.easeOut,delay:10,onComplete:function(){
            playVideo();
        }});
    }else{
        TweenMax.to(pageHome,4,{y:"-2211",delay:10,ease:Power4.easeOut})
        TweenMax.delayedCall(12,function(){
            TweenMax.to(pageHome_9,0.4,{autoAlpha:1});
             pageHome.addEventListener('touchstart', showClickVideo);
            function  showClickVideo(){
                TweenMax.to(pageHome_9,0.4,{autoAlpha:0});
                pageHome.removeEventListener('touchstart', showClickVideo);
                playVideo();
            }
        });
    }
    TweenMax.delayedCall(1.5,gotobi);
    TweenMax.delayedCall(2.2,gotobi);
}
var myaudio
function setBi(){
    myaudio = document.createElement("audio");
    myaudio.src="../../img/zhitouH5/bi.mp3";
    myaudio.loop=false;
    myaudio.load();
}
function gotobi(){
...
function playVideo(){
    if(isIphone){
        $('#video').width(640).height(1138).get(0).play();
        document.getElementById("video-wrapper").style.top="0px";
        pageHome.hide();
    }else{
        $('#video').width(640).height(1138).get(0).play();
...
function  initVideo(){
    if (isIphone) {
            ...
            $('#js-video').remove();
            $('#js-timeline').remove();
            $('.video-responsive').append('<video  poster="../../img/zhitouH5/videoBlack.jpg" src="http://station.rwcamp.com/zlei/jdb_IN/video/final.mp4" x-webkit-airplay="true" webkit-playsinline="true" id="video" width="0" height="0" style="background:transparent;"></video>')
            $('#video').get(0).load();
        ...
        $('#js-video').remove();
        $('#js-timeline').remove();
        $('.video-responsive').append('<video  poster="../../img/zhitouH5/videoBlack.jpg" src="http://station.rwcamp.com/zlei/jdb_IN/video/final.mp4" x-webkit-airplay="true" webkit-playsinline="true" id="video" width="640" height="1138"></video>')
        $('#video').get(0).load();
        $('#video').get(0).addEventListener('canplaythrough',function(){
        })
        $('#video').on('ended',function(){
    ...
    document.getElementById("video-wrapper").style.background="url(../../img/zhitouH5/videoBlack.jpg)";
    document.getElementById("video-wrapper").style.backgroundRepeat= "no-repeat";
    console.log("视频初始化！");
}
...
var pageHomekuai
function setStage(){
    pageHomekuai=new lDiv(homePage,0,0,640,1138,"",true);
    pageHome=new lDiv(pageHomekuai,0,0,640,3441,"",true);
    pageHome_1=new lImg("../../img/zhitouH5/jdb_img01.jpg",pageHome,0,0,640);
    pageHome_2=new lImg("../../img/zhitouH5/jdb_img02.jpg",pageHome,0,435,640);
    pageHome_3=new lImg("../../img/zhitouH5/jdb_img03.jpg",pageHome,0,969,640);
    pageHome_4=new lImg("../../img/zhitouH5/pl_cont.jpg",pageHome,120,1000,500,100);
    pageHome_5=new lImg("../../img/zhitouH5/pl_01.jpg",pageHome,130,1030,168);
    pageHome_6=new lImg("../../img/zhitouH5/pl_02.jpg",pageHome,130,1060,168);

    pageHome_7=new lImg("../../img/zhitouH5/jdb_img04.jpg",pageHome,0,1112,640);
    pageHome_8=new lImg("../../img/zhitouH5/videoBlack.jpg",pageHome,0,2241,640);

    if(!isIphone){
        pageHome_9=new lImg("../../img/zhitouH5/scrollup.png",main,290,465,68);
        TweenMax.to(pageHome_9,0.4,{y:-20,yoyo:true,repeat:-1});
        pageHome_9.hide();
    }

    page_back=new lImg("../../img/zhitouH5/back.gif",endPage,0,0,640);

    page_0=new lDiv(endPage,0,0,640,1138,"",true);
    page_0_txt1=new lImg("../../img/zhitouH5/video_txt.png",page_0,414,600,206);
    page_0_txt1.hide();
    page_0_logo=new lImg("../../img/zhitouH5/logomax.png",page_0,37,62,569);
    page_0_logo.hide();

    page_0_videotxt_1=new lImg("../../img/zhitouH5/video_txt1.png",page_0,195,myH-232,192);
    page_0_videotxt_1.hide();

    page_0_videotxt_2=new lImg("../../img/zhitouH5/video_txt2.png",page_0,195,myH-163,239);
    page_0_videotxt_2.hide();

    page_0_videoimg_1=new lImg("../../img/zhitouH5/videoImg_1.png",page_0,27,myH-264,167);
    page_0_videoimg_1.hide();

    page_0_videoimg_2=new lImg("../../img/zhitouH5/videoImg_2.png",page_0,444,myH-234,183);
    page_0_videoimg_2.hide();


   /* lBtn(page_0_txt1,function () {
        //了解更多
        lNavToUrlWithFillout("http://www.jiedaibao.com/");
    });*/
    setVideo();
    //-------------------------------------------------------------

    page_1=new lDiv(endPage,0,0,640,1138,"",true);
    page_1_back=new lImg("../../img/zhitouH5/img_1.png",page_1,315,myH-828,325);
    page_1_back.hide();

    page_1_txt1=new lImg("../../img/zhitouH5/page_1Txt_1.png",page_1,42,66,399);
    page_1_txt1.hide();
    page_1_txt2=new lImg("../../img/zhitouH5/page_1Txt_2.png",page_1,42,413,265);
    page_1_txt2.hide();
    page_1_txt3=new lImg("../../img/zhitouH5/page_1Txt_3.png",page_1,42,645,266);
    page_1_txt3.hide();

    //-------------------------------------------------------------
    page_2=new lDiv(endPage,0,0,640,1138,"",true);

    page_2_txt1=new lImg("../../img/zhitouH5/page_2Txt_1.png",page_2,38,61,563);
    page_2_txt1.hide();
    page_2_txt2=new lImg("../../img/zhitouH5/page_2Txt_2.png",page_2,355,370,247);
    page_2_txt2.hide();
    page_2_txt3=new lImg("../../img/zhitouH5/page_2Txt_3.png",page_2,355,590,248);
    page_2_txt3.hide()
    page_2_back=new lImg("../../img/zhitouH5/img_2.png",page_2,0,myH-725,343);
    page_2_back.hide();
    //-------------------------------------------------------------

   // page_3_txt1,page_3_txt2,page_3_txt3,page_3_txt4,page_3_back1,page_3_back2,page_3_back3,page_3_back4,page_3_back5;

    page_3=new lDiv(endPage,0,0,640,1138,"",true);

    page_3_txt1=new lImg("../../img/zhitouH5/page_3Txt_1.png",page_3,30,57,581);
    page_3_txt1.hide();
    page_3_txt2=new lImg("../../img/zhitouH5/page_3Txt_2.png",page_3,37,227,573);
    page_3_txt2.hide();
    page_3_txt3=new lImg("../../img/zhitouH5/page_3Txt_3.png",page_3,37,329,572);
    page_3_txt3.hide();
    page_3_txt4=new lImg("../../img/zhitouH5/page_3Txt_4.png",page_3,37,395,472);
    page_3_txt4.hide();


    page_3_back3=new lImg("../../img/zhitouH5/img_5.png",page_3,100,myH-352,104);
    page_3_back3.hide();
    page_3_back4=new lImg("../../img/zhitouH5/img_5.png",page_3,120,myH-292,60);
    page_3_back4.hide();
    page_3_back5=new lImg("../../img/zhitouH5/img_5.png",page_3,120,myH-382,50);
    page_3_back5.hide();
    page_3_back6=new lImg("../../img/zhitouH5/img_5.png",page_3,120,myH-330,70);
    page_3_back6.hide();



    page_3_back1=new lImg("../../img/zhitouH5/img_3.png",page_3,35,myH-426,210);
    page_3_back1.hide();
    page_3_back2=new lImg("../../img/zhitouH5/img_4.png",page_3,400,myH-440,213);
    page_3_back2.hide();
    ...
    page_btn=new lImg("../../img/zhitouH5/btn_1.png",page_3,174,myH-117,326);
    page_btn.hide();
    lBtn(page_btn,function () {
        //下载借贷宝
        lNavToUrlWithFillout("http://jdb.jiudingcapital.com/download.html?from=zhitouH5ClickDownloadBtn");
        _hmt.push(['_trackPageview', '/zhitouH5ClickDownloadBtn/']);
    });
    //-------------------------------------------------------------
    page_downBtn=new lImg("../../img/zhitouH5/btn_2.png",endPage,282,myH-40,90,57);
...
function  setVideo(){
    page_0_video= lVideo("../../img/zhitouH5/tvc.mp4",page_0,20,228,600,356,true);
    page_0_video.style.background="url(../../img/zhitouH5/video_bg.jpg)";
    page_0_video.style.backgroundRepeat= "no-repeat";
    page_0_video.video.poster="../../img/zhitouH5/video_bg2.jpg"
    page_0_video.video.style.display="none";
    page_0_video.video.addEventListener("ended",onVideoEnd);

    // lBtn(page_0_video,function(){
    //     page_0_video.video.currentTime=0;
    //     page_0_video.video.play();
    //     page_0_video.video.style.display="block";
    ...
    page_0_video.video.addEventListener("webkitfullscreenchange",function(e){
    ...
    page_0_video.addEventListener("click", function(){
        if(videoshow){
            page_0_video.video.play();
            launchFullscreen( page_0_video.video);
            page_0_video.video.style.display="block";
        }

    }, false);

    page_0_video.video.addEventListener('ended',function(){
...
//音乐
function musicB() {
    var music = lAudio("../../img/zhitouH5/music.mp3",false,true);
    //播放
    this.play = function () {
        music.play()
    };
...
function onVideoEnd(){
    page_0_video.video.currentTime=0;
    page_0_video.video.pause();
    mBtn.play();
    _hmt.push(['_trackPageview', '/zhitouH5OnVideoEnd/']);
}
...
function showEndPage(){
    ...
    pageN.to(page_0_logo,0,{y:"+=100",autoAlpha:0});
    pageN.to(page_0_video,0,{y:"+=100",autoAlpha:0});
    pageN.to(page_0_txt1,0,{y:"+=100",autoAlpha:0});

    pageN.to(page_0_videoimg_1,0,{y:"+=100",autoAlpha:0});
    pageN.to(page_0_videoimg_2,0,{y:"+=100",autoAlpha:0});

    pageN.to(page_0_videotxt_1,0,{y:"+=10",x:"-=50",autoAlpha:0});
    pageN.to(page_0_videotxt_2,0,{y:"-=10",x:"+=50",autoAlpha:0});

    pageN.to(page_downBtn,0,{autoAlpha:0});
    pageN.to(page_0,0,{autoAlpha:0});

    pageN.to(page_back,.3,{autoAlpha:1});
    pageN.to(page_0,1,{autoAlpha:1},"-=0.2");
    pageN.to(page_0_logo,1,{y:"-=100",autoAlpha:1,ease:Power4.easeOut},"-=0.7");
    pageN.to(page_0_video,1,{y:"-=100",autoAlpha:1,ease:Power4.easeOut},"-=0.7");
    pageN.to(page_0_txt1,1,{y:"-=100",autoAlpha:1,ease:Power4.easeOut},"-=0.7");
    pageN.to(page_0_videoimg_1,1,{y:"-=100",autoAlpha:1,ease:Power4.easeOut},"-=0.7");
    pageN.to(page_0_videoimg_2,1,{y:"-=100",autoAlpha:1,ease:Power4.easeOut},"-=0.7");

    pageN.to(page_0_videotxt_1,.7,{y:"-=10",x:"+=50",autoAlpha:1,ease:Power4.easeOut},"-=0.2");
    pageN.to(page_0_videotxt_2,.7,{y:"+=10",x:"-=50",autoAlpha:1,ease:Power4.easeOut},"-=0.3");
   ...
   TweenMax.to(tempPage,0.4,{autoAlpha:0});
    switch (num)
    {
        case 0:
            ...
            pageN.to(page_0_videotxt_1,.7,{y:"-=10",x:"+=50",autoAlpha:1,ease:Power4.easeOut},"-=0.5");
            pageN.to(page_0_videotxt_2,.7,{y:"+=10",x:"-=50",autoAlpha:1,ease:Power4.easeOut},"-=0.5");
        ...
        case 2:
            ...
            break;
        case 3:
            _hmt.push(['_trackPageview', '/zhitouH5LastPagePageview/']);
